...
const Login: React.FC = () => {
  const handleOAuthLogin = (provider: 'google' | 'github') => {
    ...
    alert(`OAuth with ${provider} will be implemented in backend`);
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-secondary-50 flex items-center justify-center p-4">
      <div className="card max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Infrastructure Monitoring Platform</p>
        </div>
        ...
        <div className="mt-6">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            ...
            <button
              ...
              className="btn bg-gray-900 text-white hover:bg-gray-800 flex items-center justify-center"
            >
